    ...
    while 1:
        ...
        for user in data:
            ...
            try:
                ...
                print(e)
            await sleep(0.5) # User ko message bhejte waqt rate limit se bachne ke liye
        
        # FIX: Database ko har second check karna zaroori nahi hai. 5 minute (300 sec) kaafi hai.
        await sleep(300)
